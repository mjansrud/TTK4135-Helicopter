 ...
 */
#ifndef RTW_HEADER_helicopter441_h_
#define RTW_HEADER_helicopter441_h_
#include <math.h>
#include <string.h>
#ifndef helicopter441_COMMON_INCLUDES_
# define helicopter441_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helicopter441_COMMON_INCLUDES_ */

#include "helicopter441_types.h"
...
#define helicopter441_rtModel          RT_MODEL_helicopter441_T
...
#define rtB                            helicopter441_B
#define BlockIO                        B_helicopter441_T
#define rtX                            helicopter441_X
#define ContinuousStates               X_helicopter441_T
#define rtXdot                         helicopter441_XDot
#define StateDerivatives               XDot_helicopter441_T
#define tXdis                          helicopter441_XDis
#define StateDisabled                  XDis_helicopter441_T
#define rtP                            helicopter441_P
#define Parameters                     P_helicopter441_T
#define rtDWork                        helicopter441_DW
#define D_Work                         DW_helicopter441_T

/* Parameters (auto storage) */
struct P_helicopter441_T_ {
...
struct tag_RTM_helicopter441_T {
  const char_T *path;
...
extern P_helicopter441_T helicopter441_P;

/* Block signals (auto storage) */
extern B_helicopter441_T helicopter441_B;

/* Continuous states (auto storage) */
extern X_helicopter441_T helicopter441_X;

/* Block states (auto storage) */
extern DW_helicopter441_T helicopter441_DW;

/* Model entry point functions */
extern void helicopter441_initialize(void);
extern void helicopter441_output(void);
extern void helicopter441_update(void);
extern void helicopter441_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helicopter441_T *const helicopter441_M;
 ...
 *
 * '<Root>' : 'helicopter441'
 * '<S1>'   : 'helicopter441/Conversion'
 * '<S2>'   : 'helicopter441/Degrees to Radians'
 * '<S3>'   : 'helicopter441/Elevation controller'
 * '<S4>'   : 'helicopter441/Helicopter_interface'
 * '<S5>'   : 'helicopter441/Pitch controller'
 * '<S6>'   : 'helicopter441/Helicopter_interface/Elevation rad to deg'
 * '<S7>'   : 'helicopter441/Helicopter_interface/Elevation rate rad to deg'
 * '<S8>'   : 'helicopter441/Helicopter_interface/Pitch rad to deg'
 * '<S9>'   : 'helicopter441/Helicopter_interface/Pitch rate rad to deg'
 * '<S10>'  : 'helicopter441/Helicopter_interface/Pitch rate rad to deg1'
 * '<S11>'  : 'helicopter441/Helicopter_interface/Travel rad to deg'
 * '<S12>'  : 'helicopter441/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter441_h_ */
