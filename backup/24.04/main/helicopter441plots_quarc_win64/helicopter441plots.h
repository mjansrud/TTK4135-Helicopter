/*
 * helicopter441plots.h
 *
 * Code generation for model "helicopter441plots".
 *
 * Model version              : 1.181
 * Simulink Coder version : 8.6 (R2014a) 27-Dec-2013
 * C source code generated on : Sun Apr 23 15:36:52 2017
 *
 ...
 */
#ifndef RTW_HEADER_helicopter441plots_h_
#define RTW_HEADER_helicopter441plots_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helicopter441plots_COMMON_INCLUDES_
# define helicopter441plots_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helicopter441plots_COMMON_INCLUDES_ */

#include "helicopter441plots_types.h"
...
#define helicopter441plots_rtModel     RT_MODEL_helicopter441plots_T
...
#define rtB                            helicopter441plots_B
#define BlockIO                        B_helicopter441plots_T
#define rtX                            helicopter441plots_X
#define ContinuousStates               X_helicopter441plots_T
#define rtXdot                         helicopter441plots_XDot
#define StateDerivatives               XDot_helicopter441plots_T
#define tXdis                          helicopter441plots_XDis
#define StateDisabled                  XDis_helicopter441plots_T
#define rtP                            helicopter441plots_P
#define Parameters                     P_helicopter441plots_T
#define rtDWork                        helicopter441plots_DW
#define D_Work                         DW_helicopter441plots_T

/* Parameters (auto storage) */
struct P_helicopter441plots_T_ {
...
struct tag_RTM_helicopter441plots_T {
  const char_T *path;
...
extern P_helicopter441plots_T helicopter441plots_P;

/* Block signals (auto storage) */
extern B_helicopter441plots_T helicopter441plots_B;

/* Continuous states (auto storage) */
extern X_helicopter441plots_T helicopter441plots_X;

/* Block states (auto storage) */
extern DW_helicopter441plots_T helicopter441plots_DW;

/* Model entry point functions */
extern void helicopter441plots_initialize(void);
extern void helicopter441plots_output(void);
extern void helicopter441plots_update(void);
extern void helicopter441plots_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helicopter441plots_T *const helicopter441plots_M;
 ...
 *
 * '<Root>' : 'helicopter441plots'
 * '<S1>'   : 'helicopter441plots/Conversion'
 * '<S2>'   : 'helicopter441plots/Degrees to Radians'
 * '<S3>'   : 'helicopter441plots/Elevation controller'
 * '<S4>'   : 'helicopter441plots/Helicopter_interface'
 * '<S5>'   : 'helicopter441plots/Pitch controller'
 * '<S6>'   : 'helicopter441plots/Helicopter_interface/Elevation rad to deg'
 * '<S7>'   : 'helicopter441plots/Helicopter_interface/Elevation rate rad to deg'
 * '<S8>'   : 'helicopter441plots/Helicopter_interface/Pitch rad to deg'
 * '<S9>'   : 'helicopter441plots/Helicopter_interface/Pitch rate rad to deg'
 * '<S10>'  : 'helicopter441plots/Helicopter_interface/Pitch rate rad to deg1'
 * '<S11>'  : 'helicopter441plots/Helicopter_interface/Travel rad to deg'
 * '<S12>'  : 'helicopter441plots/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter441plots_h_ */
