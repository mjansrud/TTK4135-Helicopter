/*
 * helicopter442plots.h
 *
 * Code generation for model "helicopter442plots".
 *
 * Model version              : 1.189
 * Simulink Coder version : 8.6 (R2014a) 27-Dec-2013
 * C source code generated on : Wed Apr 05 11:37:08 2017
 *
 ...
 */
#ifndef RTW_HEADER_helicopter442plots_h_
#define RTW_HEADER_helicopter442plots_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helicopter442plots_COMMON_INCLUDES_
# define helicopter442plots_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helicopter442plots_COMMON_INCLUDES_ */

#include "helicopter442plots_types.h"
...
#define helicopter442plots_rtModel     RT_MODEL_helicopter442plots_T
...
#define rtB                            helicopter442plots_B
#define BlockIO                        B_helicopter442plots_T
#define rtX                            helicopter442plots_X
#define ContinuousStates               X_helicopter442plots_T
#define rtXdot                         helicopter442plots_XDot
#define StateDerivatives               XDot_helicopter442plots_T
#define tXdis                          helicopter442plots_XDis
#define StateDisabled                  XDis_helicopter442plots_T
#define rtP                            helicopter442plots_P
#define Parameters                     P_helicopter442plots_T
#define rtDWork                        helicopter442plots_DW
#define D_Work                         DW_helicopter442plots_T

/* Parameters (auto storage) */
struct P_helicopter442plots_T_ {
...
struct tag_RTM_helicopter442plots_T {
  const char_T *path;
...
extern P_helicopter442plots_T helicopter442plots_P;

/* Block signals (auto storage) */
extern B_helicopter442plots_T helicopter442plots_B;

/* Continuous states (auto storage) */
extern X_helicopter442plots_T helicopter442plots_X;

/* Block states (auto storage) */
extern DW_helicopter442plots_T helicopter442plots_DW;

/* Model entry point functions */
extern void helicopter442plots_initialize(void);
extern void helicopter442plots_output(void);
extern void helicopter442plots_update(void);
extern void helicopter442plots_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helicopter442plots_T *const helicopter442plots_M;
 ...
 *
 * '<Root>' : 'helicopter442plots'
 * '<S1>'   : 'helicopter442plots/Conversion'
 * '<S2>'   : 'helicopter442plots/Degrees to Radians'
 * '<S3>'   : 'helicopter442plots/Elevation controller'
 * '<S4>'   : 'helicopter442plots/Helicopter_interface'
 * '<S5>'   : 'helicopter442plots/LQR'
 * '<S6>'   : 'helicopter442plots/Pitch controller'
 * '<S7>'   : 'helicopter442plots/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'helicopter442plots/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'helicopter442plots/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'helicopter442plots/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'helicopter442plots/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'helicopter442plots/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'helicopter442plots/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter442plots_h_ */
