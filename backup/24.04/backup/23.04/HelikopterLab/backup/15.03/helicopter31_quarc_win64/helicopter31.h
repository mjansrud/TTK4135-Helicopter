 ...
 */
#ifndef RTW_HEADER_helicopter31_h_
#define RTW_HEADER_helicopter31_h_
#include <math.h>
#include <string.h>
#ifndef helicopter31_COMMON_INCLUDES_
# define helicopter31_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helicopter31_COMMON_INCLUDES_ */

#include "helicopter31_types.h"
...
#define helicopter31_rtModel           RT_MODEL_helicopter31_T
...
#define rtB                            helicopter31_B
#define BlockIO                        B_helicopter31_T
#define rtX                            helicopter31_X
#define ContinuousStates               X_helicopter31_T
#define rtXdot                         helicopter31_XDot
#define StateDerivatives               XDot_helicopter31_T
#define tXdis                          helicopter31_XDis
#define StateDisabled                  XDis_helicopter31_T
#define rtP                            helicopter31_P
#define Parameters                     P_helicopter31_T
#define rtDWork                        helicopter31_DW
#define D_Work                         DW_helicopter31_T

/* Parameters (auto storage) */
struct P_helicopter31_T_ {
...
extern P_helicopter31_T helicopter31_P;

/* Block signals (auto storage) */
extern B_helicopter31_T helicopter31_B;

/* Continuous states (auto storage) */
extern X_helicopter31_T helicopter31_X;

/* Block states (auto storage) */
extern DW_helicopter31_T helicopter31_DW;

/* Model entry point functions */
extern void helicopter31_initialize(void);
extern void helicopter31_output(void);
extern void helicopter31_update(void);
extern void helicopter31_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helicopter31_T *const helicopter31_M;
 ...
 *
 * '<Root>' : 'helicopter31'
 * '<S1>'   : 'helicopter31/Conversion'
 * '<S2>'   : 'helicopter31/Degrees to Radians'
 * '<S3>'   : 'helicopter31/Elevation controller'
 * '<S4>'   : 'helicopter31/Helicopter_interface'
 * '<S5>'   : 'helicopter31/LQR'
 * '<S6>'   : 'helicopter31/Pitch controller'
 * '<S7>'   : 'helicopter31/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'helicopter31/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'helicopter31/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'helicopter31/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'helicopter31/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'helicopter31/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'helicopter31/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter31_h_ */
