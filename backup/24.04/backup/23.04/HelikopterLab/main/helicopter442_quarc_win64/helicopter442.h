 ...
 */
#ifndef RTW_HEADER_helicopter442_h_
#define RTW_HEADER_helicopter442_h_
#include <math.h>
#include <string.h>
#ifndef helicopter442_COMMON_INCLUDES_
# define helicopter442_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helicopter442_COMMON_INCLUDES_ */

#include "helicopter442_types.h"
...
#define helicopter442_rtModel          RT_MODEL_helicopter442_T
...
#define rtB                            helicopter442_B
#define BlockIO                        B_helicopter442_T
#define rtX                            helicopter442_X
#define ContinuousStates               X_helicopter442_T
#define rtXdot                         helicopter442_XDot
#define StateDerivatives               XDot_helicopter442_T
#define tXdis                          helicopter442_XDis
#define StateDisabled                  XDis_helicopter442_T
#define rtP                            helicopter442_P
#define Parameters                     P_helicopter442_T
#define rtDWork                        helicopter442_DW
#define D_Work                         DW_helicopter442_T

/* Parameters (auto storage) */
struct P_helicopter442_T_ {
...
struct tag_RTM_helicopter442_T {
  const char_T *path;
...
extern P_helicopter442_T helicopter442_P;

/* Block signals (auto storage) */
extern B_helicopter442_T helicopter442_B;

/* Continuous states (auto storage) */
extern X_helicopter442_T helicopter442_X;

/* Block states (auto storage) */
extern DW_helicopter442_T helicopter442_DW;

/* Model entry point functions */
extern void helicopter442_initialize(void);
extern void helicopter442_output(void);
extern void helicopter442_update(void);
extern void helicopter442_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helicopter442_T *const helicopter442_M;
 ...
 *
 * '<Root>' : 'helicopter442'
 * '<S1>'   : 'helicopter442/Conversion'
 * '<S2>'   : 'helicopter442/Degrees to Radians'
 * '<S3>'   : 'helicopter442/Elevation controller'
 * '<S4>'   : 'helicopter442/Helicopter_interface'
 * '<S5>'   : 'helicopter442/LQR'
 * '<S6>'   : 'helicopter442/Pitch controller'
 * '<S7>'   : 'helicopter442/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'helicopter442/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'helicopter442/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'helicopter442/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'helicopter442/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'helicopter442/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'helicopter442/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter442_h_ */
