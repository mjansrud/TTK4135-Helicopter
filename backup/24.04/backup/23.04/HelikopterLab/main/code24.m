...
code23; % NB: Change this to the init file corresponding to your helicopter
...
subplot(514)
hold on
pitch_prediction = plot(x_state(1,:),x_state(4,:),'b');
pitch_meassured = plot(x_state(1,:),x_state(8,:),'r');

hold off
ylabel('p')
subplot(515)
hold on
pitch_rate_prediction = plot(x_state(1,:),x_state(5,:),'b');
pitch_rate_meassured = plot(x_state(1,:),x_state(9,:),'r');
