 ...
 */
#ifndef RTW_HEADER_helicopter44_h_
#define RTW_HEADER_helicopter44_h_
#include <math.h>
#include <string.h>
#ifndef helicopter44_COMMON_INCLUDES_
# define helicopter44_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helicopter44_COMMON_INCLUDES_ */

#include "helicopter44_types.h"
...
#define helicopter44_rtModel           RT_MODEL_helicopter44_T
...
#define rtB                            helicopter44_B
#define BlockIO                        B_helicopter44_T
#define rtX                            helicopter44_X
#define ContinuousStates               X_helicopter44_T
#define rtXdot                         helicopter44_XDot
#define StateDerivatives               XDot_helicopter44_T
#define tXdis                          helicopter44_XDis
#define StateDisabled                  XDis_helicopter44_T
#define rtP                            helicopter44_P
#define Parameters                     P_helicopter44_T
#define rtDWork                        helicopter44_DW
#define D_Work                         DW_helicopter44_T

/* Parameters (auto storage) */
struct P_helicopter44_T_ {
...
extern P_helicopter44_T helicopter44_P;

/* Block signals (auto storage) */
extern B_helicopter44_T helicopter44_B;

/* Continuous states (auto storage) */
extern X_helicopter44_T helicopter44_X;

/* Block states (auto storage) */
extern DW_helicopter44_T helicopter44_DW;

/* Model entry point functions */
extern void helicopter44_initialize(void);
extern void helicopter44_output(void);
extern void helicopter44_update(void);
extern void helicopter44_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helicopter44_T *const helicopter44_M;
 ...
 *
 * '<Root>' : 'helicopter44'
 * '<S1>'   : 'helicopter44/Conversion'
 * '<S2>'   : 'helicopter44/Degrees to Radians'
 * '<S3>'   : 'helicopter44/Elevation controller'
 * '<S4>'   : 'helicopter44/Helicopter_interface'
 * '<S5>'   : 'helicopter44/Pitch controller'
 * '<S6>'   : 'helicopter44/Helicopter_interface/Elevation rad to deg'
 * '<S7>'   : 'helicopter44/Helicopter_interface/Elevation rate rad to deg'
 * '<S8>'   : 'helicopter44/Helicopter_interface/Pitch rad to deg'
 * '<S9>'   : 'helicopter44/Helicopter_interface/Pitch rate rad to deg'
 * '<S10>'  : 'helicopter44/Helicopter_interface/Pitch rate rad to deg1'
 * '<S11>'  : 'helicopter44/Helicopter_interface/Travel rad to deg'
 * '<S12>'  : 'helicopter44/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter44_h_ */
