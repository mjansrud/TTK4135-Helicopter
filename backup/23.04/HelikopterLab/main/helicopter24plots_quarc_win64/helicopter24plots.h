 ...
 */
#ifndef RTW_HEADER_helicopter24plots_h_
#define RTW_HEADER_helicopter24plots_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helicopter24plots_COMMON_INCLUDES_
# define helicopter24plots_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helicopter24plots_COMMON_INCLUDES_ */

#include "helicopter24plots_types.h"
...
#define helicopter24plots_rtModel      RT_MODEL_helicopter24plots_T
...
typedef struct {
  ...
  real_T TmpSignalConversionAtToFileInpo[10];
  real_T Sum_k;                        /* '<S5>/Sum' */
  real_T Sum2;                         /* '<S3>/Sum2' */
  real_T K_ei;                         /* '<S3>/K_ei' */
...
#define rtB                            helicopter24plots_B
#define BlockIO                        B_helicopter24plots_T
#define rtX                            helicopter24plots_X
#define ContinuousStates               X_helicopter24plots_T
#define rtXdot                         helicopter24plots_XDot
#define StateDerivatives               XDot_helicopter24plots_T
#define tXdis                          helicopter24plots_XDis
#define StateDisabled                  XDis_helicopter24plots_T
#define rtP                            helicopter24plots_P
#define Parameters                     P_helicopter24plots_T
#define rtDWork                        helicopter24plots_DW
#define D_Work                         DW_helicopter24plots_T

/* Parameters (auto storage) */
struct P_helicopter24plots_T_ {
...
struct tag_RTM_helicopter24plots_T {
  const char_T *path;
...
extern P_helicopter24plots_T helicopter24plots_P;

/* Block signals (auto storage) */
extern B_helicopter24plots_T helicopter24plots_B;

/* Continuous states (auto storage) */
extern X_helicopter24plots_T helicopter24plots_X;

/* Block states (auto storage) */
extern DW_helicopter24plots_T helicopter24plots_DW;

/* Model entry point functions */
extern void helicopter24plots_initialize(void);
extern void helicopter24plots_output(void);
extern void helicopter24plots_update(void);
extern void helicopter24plots_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helicopter24plots_T *const helicopter24plots_M;
 ...
 *
 * '<Root>' : 'helicopter24plots'
 * '<S1>'   : 'helicopter24plots/Conversion'
 * '<S2>'   : 'helicopter24plots/Degrees to Radians'
 * '<S3>'   : 'helicopter24plots/Elevation controller'
 * '<S4>'   : 'helicopter24plots/Helicopter_interface'
 * '<S5>'   : 'helicopter24plots/Pitch controller'
 * '<S6>'   : 'helicopter24plots/Helicopter_interface/Elevation rad to deg'
 * '<S7>'   : 'helicopter24plots/Helicopter_interface/Elevation rate rad to deg'
 * '<S8>'   : 'helicopter24plots/Helicopter_interface/Pitch rad to deg'
 * '<S9>'   : 'helicopter24plots/Helicopter_interface/Pitch rate rad to deg'
 * '<S10>'  : 'helicopter24plots/Helicopter_interface/Pitch rate rad to deg1'
 * '<S11>'  : 'helicopter24plots/Helicopter_interface/Travel rad to deg'
 * '<S12>'  : 'helicopter24plots/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter24plots_h_ */
