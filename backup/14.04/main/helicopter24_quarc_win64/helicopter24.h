 ...
 */
#ifndef RTW_HEADER_helicopter24_h_
#define RTW_HEADER_helicopter24_h_
#include <math.h>
#include <string.h>
#ifndef helicopter24_COMMON_INCLUDES_
# define helicopter24_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helicopter24_COMMON_INCLUDES_ */

#include "helicopter24_types.h"
...
#define helicopter24_rtModel           RT_MODEL_helicopter24_T
...
#define rtB                            helicopter24_B
#define BlockIO                        B_helicopter24_T
#define rtX                            helicopter24_X
#define ContinuousStates               X_helicopter24_T
#define rtXdot                         helicopter24_XDot
#define StateDerivatives               XDot_helicopter24_T
#define tXdis                          helicopter24_XDis
#define StateDisabled                  XDis_helicopter24_T
#define rtP                            helicopter24_P
#define Parameters                     P_helicopter24_T
#define rtDWork                        helicopter24_DW
#define D_Work                         DW_helicopter24_T

/* Parameters (auto storage) */
struct P_helicopter24_T_ {
...
extern P_helicopter24_T helicopter24_P;

/* Block signals (auto storage) */
extern B_helicopter24_T helicopter24_B;

/* Continuous states (auto storage) */
extern X_helicopter24_T helicopter24_X;

/* Block states (auto storage) */
extern DW_helicopter24_T helicopter24_DW;

/* Model entry point functions */
extern void helicopter24_initialize(void);
extern void helicopter24_output(void);
extern void helicopter24_update(void);
extern void helicopter24_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helicopter24_T *const helicopter24_M;
 ...
 *
 * '<Root>' : 'helicopter24'
 * '<S1>'   : 'helicopter24/Conversion'
 * '<S2>'   : 'helicopter24/Degrees to Radians'
 * '<S3>'   : 'helicopter24/Elevation controller'
 * '<S4>'   : 'helicopter24/Helicopter_interface'
 * '<S5>'   : 'helicopter24/Pitch controller'
 * '<S6>'   : 'helicopter24/Helicopter_interface/Elevation rad to deg'
 * '<S7>'   : 'helicopter24/Helicopter_interface/Elevation rate rad to deg'
 * '<S8>'   : 'helicopter24/Helicopter_interface/Pitch rad to deg'
 * '<S9>'   : 'helicopter24/Helicopter_interface/Pitch rate rad to deg'
 * '<S10>'  : 'helicopter24/Helicopter_interface/Pitch rate rad to deg1'
 * '<S11>'  : 'helicopter24/Helicopter_interface/Travel rad to deg'
 * '<S12>'  : 'helicopter24/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter24_h_ */
